  ...
  return (
    <div className="flex h-screen bg-fixed bg-center bg-cover custom-img">
      <div className="flex flex-col justify-center items-center absolute top-0 left-0 right-0 bottom-0 bg-black/50">
        <div className="text-white text-4xl md:text-7xl">Mark Protsyuk</div>
        ...
        <div className="border text-sm md:text-lg rounded-sm mt-2 p-2 sm:p-4 text-white hover:bg-white hover:text-gray-500">
          <Link
            target="_blank"
