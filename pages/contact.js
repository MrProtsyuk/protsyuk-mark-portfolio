...
export default function Contact() {
  ...
  return (
    <div
      ref={contactRef}
      className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-white to-gray-200"
    >
      <p className="text-green-800 text-4xl md:text-5xl my-4">
        Certification and Contact
      </p>
      <div className="flex flex-wrap justify-center items-center">
        <div className="flex flex-col justify-center items-center gap-4 border rounded-md border-slate-500 p-0 m-0 sm:p-2 sm:m-4 bg-gradient-to-l from-white to-gray-300 w-72 sm:w-auto drop-shadow-2xl">
          <Image
            width={300}
            height={300}
        ...
        <div className="flex flex-col justify-center items-center gap-4 border rounded-md border-slate-500 p-2 m-4 sm:p-4 sm:m-4 mb-8 bg-gradient-to-r from-white to-gray-300 w-72 sm:w-6/12 h-5/6 drop-shadow-2xl">
