...
export default function About() {
  return (
    ...
    >
      <div className="text-green-800 text-4xl md:text-5xl 2xl:text-7xl mt-6">
        About Myself
      </div>
      <div className="flex flex-wrap justify-center items-center pb-10">
        <Image
          ...
          width={400}
          height={200}
          className="w-72 sm:w-80 2xl:w-2/12 border rounded-lg border-transparent m-8 drop-shadow-2xl"
        />
        <div className="flex flex-col w-72 sm:w-5/12 h-auto border bg-gradient-to-r from-white to-gray-200 border-slate-500 rounded-md drop-shadow-2xl p-5 my-5">
          <p className="p-4 text-sm sm:text-lg 2xl:text-2xl">
          ...
          <div className="flex flex-row gap-6 justify-center my-4">
            <Image
              className="drop-shadow-sm hover:drop-shadow-2xl md:w-20"
              width={60}
              height={1}
            ...
            />
            <Image
              className="drop-shadow-sm hover:drop-shadow-xl md:w-20"
              width={60}
              height={1}
